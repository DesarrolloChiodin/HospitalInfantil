...
namespace ControlDePacientes.Dal
{
    public class ComunidadLinguistica
    {
        ...
        public DataTable GetComunidadLinguisticaByGrupoEtnico(int pGrupoEtnicoId)
        {
            using (MySqlConnection conn = new MySqlConnection(connStr))
            {
                {
                    //ejecuto sp para la consulta de Usuarios
                    MySqlCommand cmd = new MySqlCommand("ComLingByGrupoEtnico", conn);
                    cmd.Parameters.Add("@pGrupoEtnicoId", MySqlDbType.String).Value = pGrupoEtnicoId;
        ...
        public DataTable GetComunidadLinguisticaAll()
        {
            using (MySqlConnection conn = new MySqlConnection(connStr))
            {
                {
                    //ejecuto sp para la consulta de Usuarios
                    MySqlCommand cmd = new MySqlCommand("ComLingGetAll", conn);
